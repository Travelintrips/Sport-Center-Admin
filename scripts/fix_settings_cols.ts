...
async function main() {
  ...
  const stmts = [
    ...
    `ALTER TABLE sport_center.settings ADD COLUMN IF NOT EXISTS qris_image_url text`,
    `ALTER TABLE sport_center.settings ADD COLUMN IF NOT EXISTS logo_url text`,
    `ALTER TABLE sport_center.settings ADD COLUMN IF NOT EXISTS bank_name text`,
    `ALTER TABLE sport_center.settings ADD COLUMN IF NOT EXISTS bank_account text`,
    `ALTER TABLE sport_center.settings ADD COLUMN IF NOT EXISTS bank_account_name text`,
    `ALTER TABLE sport_center.settings ADD COLUMN IF NOT EXISTS open_hour text`,
    `ALTER TABLE sport_center.settings ADD COLUMN IF NOT EXISTS close_hour text`,
    // seed tax settings
