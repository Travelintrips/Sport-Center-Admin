...
const stmts = [
  ...
  `ALTER TABLE sport_center.users ADD COLUMN IF NOT EXISTS ppn_enabled boolean NOT NULL DEFAULT true`,
  `ALTER TABLE sport_center.users ADD COLUMN IF NOT EXISTS withholding_tax_enabled boolean NOT NULL DEFAULT false`,
  `ALTER TABLE sport_center.users ADD COLUMN IF NOT EXISTS withholding_tax_rate numeric(5,2) NOT NULL DEFAULT 10`,
  ...
  `ALTER TABLE sport_center.sport_bookings ADD COLUMN IF NOT EXISTS dpp numeric(14,2)`,
  ...
  `ALTER TABLE sport_center.sport_bookings ADD COLUMN IF NOT EXISTS ppn_treatment text NOT NULL DEFAULT 'none'`,
  `ALTER TABLE sport_center.sport_bookings ADD COLUMN IF NOT EXISTS ppn_collected_by_customer boolean NOT NULL DEFAULT false`,
  `ALTER TABLE sport_center.sport_bookings ADD COLUMN IF NOT EXISTS pph_rate numeric(5,2)`,
  `ALTER TABLE sport_center.sport_bookings ADD COLUMN IF NOT EXISTS pph_amount numeric(14,2)`,
  `ALTER TABLE sport_center.sport_bookings ADD COLUMN IF NOT EXISTS net_amount numeric(14,2)`,
