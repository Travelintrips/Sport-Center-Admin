...
- Admin/customer booking detail and company invoices use `pphAmount = DPP × rate` and `netAmount = (DPP + PPN) − PPh` so stale snapshots cannot override the displayed formula.
