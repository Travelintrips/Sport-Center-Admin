...
**How to apply:** Preserve fail-closed section/environment validation and never log payload values. Keep the shared secret ID as runtime configuration, not as an environment marker in its name.