...
export const companyInvoicesTable = scSchema.table("company_invoices", {
  ...
  ppnRate: numeric("ppn_rate", { precision: 5, scale: 2 }).notNull().default("0"),
  ppnTreatment: text("ppn_treatment").notNull().default("normal"),
  ppnCollectedByCustomer: boolean("ppn_collected_by_customer").notNull().default(false),
  pphRate: numeric("pph_rate", { precision: 5, scale: 2 }).notNull().default("0"),
  pphAmount: numeric("pph_amount", { precision: 14, scale: 2 }).notNull().default("0"),
...
export const companyInvoiceItemsTable = scSchema.table("company_invoice_items", {
  ...
  ppnTreatment: text("ppn_treatment"),
  ppnCollectedByCustomer: boolean("ppn_collected_by_customer").notNull().default(false),
