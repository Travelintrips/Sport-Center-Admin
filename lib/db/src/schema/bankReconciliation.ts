...
export const bankJournalEntriesTable = scSchema.table("bank_journal_entries", {
  ...
  // Immutable payment metadata snapshot captured when the bank journal posts.
  ...
  paymentCompanyId: integer("payment_company_id"),
  paymentBankAccountId: text("payment_bank_account_id"),
  paymentExpectedSettlementDate: text("payment_expected_settlement_date"),
  paymentMdrRate: numeric("payment_mdr_rate", { precision: 8, scale: 5 }),
  paymentMdrAmount: numeric("payment_mdr_amount", { precision: 14, scale: 2 }),
  paymentSettlementStatus: text("payment_settlement_status"),
