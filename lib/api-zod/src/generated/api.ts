...
export const ListFacilityCompanyMappingsResponse = zod.unknown()
...
export const CreateFacilityCompanyMappingResponse = zod.void()
...
export const UpdateFacilityCompanyMappingResponse = zod.unknown()


/**
 * @summary Dry-run repair readiness for payments 13 and 14
 */
export const AuditSportCenterPayments1314DryRunResponse = zod.unknown()


/**
 * @summary Dry-run historical ownership classifier
 */
export const AuditSportCenterOwnershipDryRunResponse = zod.unknown()
...
export const CreateRecurringBookingResponse = zod.object({
...
export const CreatePromoResponse = zod.object({
  "id": zod.number(),
  "title": zod.string(),
  "description": zod.string().nullish(),
  "type": zod.enum(['promo', 'event']),
...
export const DeletePromoResponse = zod.void()
...
export const RegisterPromoResponse = zod.object({
  "id": zod.number(),
  "promoId": zod.number(),
  "name": zod.string(),
  "email": zod.string(),
...
export const CreateBlockedScheduleResponse = zod.object({
  "id": zod.number(),
  "facilityId": zod.number(),
  "facilityName": zod.string().nullish(),
  "date": zod.string(),
...
export const DeleteBlockedScheduleResponse = zod.void()
...
export const ListCustomersResponseItem = zod.object({
  ...
  "ppnEnabled": zod.boolean().optional(),
...
export const CreateCompanyVerificationResponse = zod.void()
...
export const ApproveCompanyVerificationResponse = zod.unknown()
...
export const RejectCompanyVerificationResponse = zod.unknown()
...
export const RevokeCompanyVerificationResponse = zod.unknown()
...
export const ToggleCompanyUserBillingResponse = zod.unknown()
...
export const GenerateCompanyInvoiceResponse = zod.object({
  "id": zod.number(),
  "invoiceNumber": zod.string(),
  "companyCustomerId": zod.number(),
  "companyName": zod.string().optional(),
...
export const GenerateCompanyInvoiceAliasResponse = zod.object({
  "id": zod.number(),
  "invoiceNumber": zod.string(),
  "companyCustomerId": zod.number(),
  "companyName": zod.string().optional(),
...
export const GetSettingsResponse = zod.object({
  ...
  "fonnteCustomerDevice": zod.string().nullish(),
...
export const UpdateSettingsBody = zod.object({
  ...
  "fonnteCustomerDevice": zod.string().optional(),
...
export const CreateApMemberResponse = zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "phone": zod.string().nullish(),
  "email": zod.string().nullish(),
...
export const DeleteApMemberResponse = zod.void()
...
export const CreateTenantBookingResponse = zod.object({
  "id": zod.number(),
  "orderNumber": zod.string(),
  "tenantId": zod.number(),
  "userId": zod.number().nullish(),
...
export const CreateTenantPaymentResponse = zod.object({
  "id": zod.number(),
  "tenantBookingId": zod.number(),
  "proofImageUrl": zod.string().nullish(),
  "amount": zod.number(),
...
export const CreateAdminTenantResponse = zod.void()
...
export const UpdateAdminTenantStatusResponse = zod.unknown()
...
export const UpdateAdminTenantBookingResponse = zod.unknown()
...
export const VerifyAdminTenantPaymentResponse = zod.unknown()
...
export const RejectAdminTenantPaymentResponse = zod.unknown()
...
export const PreviewDocumentResponse = zod.unknown()
...
export const GenerateDocumentPdfResponse = zod.unknown()
