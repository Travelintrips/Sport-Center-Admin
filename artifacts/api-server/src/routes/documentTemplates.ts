...
router.get("/public/kwitansi-data/:orderNumber", async (req, res) => {
  try {
    ...
    res.json({
      ...
      pphRate: booking.pphRate != null ? Number(booking.pphRate) : null,
      pphAmount: booking.pphAmount != null ? Number(booking.pphAmount) : null,
      netAmount: booking.netAmount != null ? Number(booking.netAmount) : null,
